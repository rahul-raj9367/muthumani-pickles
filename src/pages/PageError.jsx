...
<Box mt="100px">
      ...
      <Center><Link to="/"><Button bg='#B31312' mt="15%" _hover={{ bg: 'black', color:'#ffff' }} ml={["","","5%","5%"]} color='#ffffff' leftIcon={<FaHome size={20} />}  onClick={() => setActiveButton(1)}>Back to Home</Button></Link></Center>
    </Box>
